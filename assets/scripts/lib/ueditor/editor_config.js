...
(function () {
    ...
    URL = window.UEDITOR_HOME_URL||'/scripts/lib/ueditor/';//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['bold', 'underline', 'strikethrough', 'insertunorderedlist','insertorderedlist', '|',
        ...
        ,initialFrameWidth:556  //初始化编辑器宽度,默认1000
